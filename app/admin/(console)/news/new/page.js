...
export default async function NewArticle() {
  ...
  return (
    <div className="page page--editor">
      <ArticleEditor article={null} categories={categories} sourceOptions={sources} entityOptions={entities} isAdmin={isAdminProfile(profile)} authorDefault={profile?.display_name || ''} />
    </div>
  );
}
