...
if (process.env.DEEPL_API_KEY) ok(`DEEPL_API_KEY (${process.env.DEEPL_API_KEY.endsWith(':fx') ? 'free' : 'pro'} plan: automatic translation enabled)`);
else warn('DEEPL_API_KEY not set: automatic translation is disabled (optional).');
